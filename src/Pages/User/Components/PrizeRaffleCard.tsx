...
const UserPrizeRaffleCard = ({ item, i }: any) => {
                ...
                {indexValue === i && (
                    ...
                    >
                        <button
                            ...
                            onClick={() =>
                                navigate(`/raffle/details/${item?.uniqueID}`)
                            }
                        >
                            <svg
                                width="11"
                ...
                <div className='w-[90%] m-auto text-white mt-8 pb-6 '>
                        ...
                        <div className='flex items-center gap-2'>
                            ...
                            <div>
                                <div className='flex items-center gap-1'>
                                    {/* <span className='text-md font-light'>by</span> <h4 className='text-md font-medium'>{item.title}</h4> */}
                                </div>
                                <div>
                                    {/* <div className='flex items-center gap-1'>
                    ...
                    <div className='mt-6'>
                        ...
                        <div className='items-center'>
                            <p className='text-sm'>Winning Amount: <span className='ml-2'><b>£{item?.prize_data?.prize_value ? item?.prize_data?.prize_value : item.prize_data?.instant_prize}</b></span></p>
                            <p className='text-sm'>Prize Name:<span className='ml-2'><b>{item?.prize_data?.prize_name ? item?.prize_data?.prize_name : item.prize_data?.instant_prize}</b></span></p>
                            {/* <h3 className='font-medium text-md tracking-wider'>$</h3> */}
                        </div>
                        <div className='items-center gap-2 mt-2'>
                            <p className='text-sm'>Ticket ID:</p>
                            <h3 className='font-medium  tracking-wider text-[10px]'>${item?.prize_data?.ticketID}</h3>
                        </div>
                    </div>
...
export default UserPrizeRaffleCard