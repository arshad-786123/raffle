        ...
        <div className="rounded-md">
          ...
          <Modal.Body className="bg-white text-secondary  h-full xs:h-auto rounded-b-md" style={{ fontFamily: "poppins, sans-serif" }}>
            ...
            <div className="mt-2" style={{ color: "black", fontFamily: "poppins, sans-serif" }}>
              <h3 className="text-center text-md lg:text-lg font-bold tracking-wider">
                Step 1: Complete your information
              </h3>
            </div>
            <div className="mt-4" style={{ color: "black", fontFamily: "poppins, sans-serif" }}>
              ...
              {/* <p className='mt-4 text-sm lg:text-md'>Referral Code</p>
                            <div className='flex items-center justify-between gap-4 rounded-md p-2 lg:p-4 border-[1px] mt-2'>
                                <input onChange={handleChange} value={userRegisterData.referralCode} className='border-none outline-none w-[100%]' type="text" placeholder='leave blank if no code' name="referralCode" id="referralCode" />
                            </div> */}
              {/* <div className="flex items-start gap-2 text-xs mt-2">
                <Checkbox id="accept" defaultChecked />
                <p>
                  I would like to receive exciting updates on raffles.my chosen
                  charity, partner promotions, exclusive discounts and free
                  tickets!
                </p>
              </div> */}
              {/* <div className="flex items-start gap-2 text-xs mt-2">
            ...
            <div className=" mt-4 w-[100%] m-auto text-left text-xs " style={{ color: "black", fontFamily: "poppins, sans-serif" }}>
              By creating an account you agree that you are at least 18 years of
              age, and accept and agree to the &nbsp;
              <span className='text-[#EB4C60] font-bold'><a
                href="/merchant-terms-and-condition"
