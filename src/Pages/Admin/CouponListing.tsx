    ...
    const handleCopy = (couponName: string) => {
        ...
        if (navigator.clipboard) {
            navigator.clipboard.writeText(couponName)
                .then(() => successToast('Coupon name copied!'))
                .catch(err => errorToast('Failed to copy coupon name'));
        } else {
            // Fallback method for older browsers
            const textArea = document.createElement('textarea');
            textArea.value = couponName;
            ...
            try {
                ...
                errorToast('Failed to copy coupon name');
            }
            ...
            <div className='w-[100%] lg:w-[95%] mx-auto z-10 p-3 lg:p-10 duration-500' style={{ fontFamily: "poppins, sans-serif" }} >
                <div className='m-auto w-[100%] lg:w-[90%]'>
                    <nav aria-label="breadcrumb" className="breadcrumb-container flex justify-between">
                        ...
                        <ol className="breadcrumb">
                            <li className="breadcrumb-item">
                                <Link to="/admin/coupon/create" className="breadcrumb-link">+ Create</Link>
                            </li>
                        </ol>
                    </nav>
                </div>
                                    ...
                                    <div className='hidden lg:block lg:flex items-center justify-between bg-white p-2 rounded-md mt-4'>
                                        ...
                                        <div className='w-[90%]'>
                                            <table className='w-[100%]' >
                                                <thead className='border-b-[2px] grid grid-cols-6 gap-4'>
                                                    ...
                                                    <th className='font-[400] text-[15px]'>Usage Count</th>
                                                ...
                                                <tbody>
                                                    <tr className='grid grid-cols-6 gap-4'>
                                                        ...
                                                        <td className='text-center'>{item?.usageCount || 0}/{item?.usageLimit || 0}</td>
                                        ...
                                        <div className='w-[100%]'>
                                            ...
                                            <table className='w-[100%]' >
                                                <thead className='border-b-[2px]'>
                                                    ...
                                                    <th className='font-[400] text-[10px]'>Usage Count</th>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td className='text-center text-[10px]'>{item?.type}</td>
                                                        <td className='text-center text-[10px]'>{item?.amount}</td>
                                                        <td className='text-center text-[10px]'>{item?.usageCount || 0}/{item?.usageLimit || 0}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <br />
