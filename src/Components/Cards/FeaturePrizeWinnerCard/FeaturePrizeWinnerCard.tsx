...
const FeaturePrizeWinnerCard = () => {
  return (
    <div className="w-full min-w-[312px] h-full min-h-[478px] border rounded-[16px] relative">
      {/* <div className="flex items-center justify-between p-4">
        ...
        <div className="">
          <Badge variant="outline" className="border-raffles-blue">
            <span className="text-[12px] leading-[16.8px]">WINNER</span>
          </Badge>
        </div>
      </div> */}
      ...
      <div className="w-full mt-3 px-4">
        <h5 className="font-modernBold font-bold text-[20px] leading-[24px] text-raffles-blue mb-1">
          Tripgrade Orange Flatsole Sneakers{" "}
        </h5>
        <p className="text-[14px] leading-[19.6px]">
          “I can’t believe it! This was such an amazing experience!”
        </p>
      </div>
      <div className="absolute bottom-2 left-4">
        <span className="font-modernBold font-bold text-[14px] leading-[19.6px] text-raffles-blue">
          Winning Ticket No: xxxx3658
        </span>
      </div>
    </div>
  );
...
export default FeaturePrizeWinnerCard;
