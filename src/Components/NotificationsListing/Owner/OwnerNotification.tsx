...
import { deleteCouponList, getCouponListingData } from '../../../Services/Admin/getDashboardData';
...
import { ownerNotificationListing } from '../../../Services/Owner/getRaffle';
    ...
    const getDashboardData = async (page: any) => {
        try {
            ...
            if (persistedData) {
                ...
                const res = await ownerNotificationListing(ownerId, page, itemsPerPage);
